...
//writable -- 如果为true，允许写访问权限;如果为false，写访问权限是不允许的。
    ...
    public static void initRoot(Context context) {
        ROOT_PATH =String.format("%s/%s/", Environment.getExternalStorageDirectory(),"WuIm");
//        createOrExistsFile(ROOT_PATH);
        createOrExistsDir(getVoiceFilePath());
        createOrExistsDir(getImageFilePath());
        createOrExistsDir(getVideoFilePath());
    }


    public static String getVoiceFilePath() {
        return ROOT_PATH + "voice/";
    }
    public static String getVideoFilePath() {
        return ROOT_PATH + "video/";
    }

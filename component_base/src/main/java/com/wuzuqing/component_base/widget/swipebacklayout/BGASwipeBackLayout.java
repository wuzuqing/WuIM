...
package com.wuzuqing.component_base.widget.swipebacklayout;
...
public class BGASwipeBackLayout extends ViewGroup {
    ...
    private boolean isSwipeBackEnable() {
        return mSwipeBackEnable && BaseApplication.getAppContext().getActivityControl().getPenultimateActivity() != null;
    }
    // ======================== 新加的 END ========================
...
//        mOverhangSize = (int) (DEFAULT_OVERHANG_SIZE * density + 0.5f);
    ...
    void dispatchOnPanelSlide(View panel) {
        // ======================== 新加的 START ========================
        if (mIsWeChatStyle) {
            BaseApplication.getAppContext().getActivityControl().onPanelSlide(mSlideOffset);
        }
        // ======================== 新加的 END ========================
    ...
    void dispatchOnPanelClosed(View panel) {
        // ======================== 新加的 START ========================
        if (mIsWeChatStyle) {
            BaseApplication.getAppContext().getActivityControl().onPanelClosed();
        }
        // ======================== 新加的 END ========================

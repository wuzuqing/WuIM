package com.wuzuqing.component_base.helper;
...
//        return new Locale(lang);
    ...
    private static void persistLocal(Context context, Locale locale) {
        SPUtils.saveObject(context, SELECTED_LANGUAGE, locale);
    }

    private static Locale getPersistedLocal(Context context, Locale defaultLocale) {
        return (Locale) SPUtils.readObject(context, SELECTED_LANGUAGE, defaultLocale);
    }

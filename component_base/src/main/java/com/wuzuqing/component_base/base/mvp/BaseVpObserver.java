...
public abstract class BaseVpObserver<T> extends ResourceObserver<T> {
    ...
    protected void onStart() {
        ...
        mCurrentActivity =  BaseApplication.getAppContext().getActivityControl().getCurrentActivity();
        if (mCurrentActivity != null && !NetworkUtils.isNetConnected(mCurrentActivity)) {
  ...
  //  }
    ...
    public void onError(Throwable e) {
        ...
        if (mCurrentActivity != null){
            Toast.makeText( BaseApplication.getAppContext().getActivityControl().getCurrentActivity(), errorMsgmsg, Toast.LENGTH_SHORT).show();
        }

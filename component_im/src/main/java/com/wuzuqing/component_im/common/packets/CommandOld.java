...
public enum CommandOld {
     ...
     */
    COMMAND_GET_OFFLINE_MESSAGE_REQ(21),
    /**
     * <pre>
     * 获取历史聊天消息响应;
     * </pre>
     ...
     * <code>COMMAND_GET_OFFLINE_MESSAGE_RESP = 21;</code>
     */
    COMMAND_GET_OFFLINE_MESSAGE_RESP(22),;

    public final int getNumber() {
        return value;
    }

    public static CommandOld valueOf(int value) {
        return forNumber(value);
    }

    public static CommandOld forNumber(int value) {
        switch (value) {
            case 0:

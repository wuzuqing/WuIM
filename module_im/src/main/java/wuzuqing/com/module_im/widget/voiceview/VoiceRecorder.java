...
public class VoiceRecorder {
    ...
    public String startRecording(Context appContext) {
        ...
        try {
            ...
            voiceFilePath = FileUtils.getVoiceFilePath() + voiceFileName;
    ...
    private String getVoiceFileName(long time) {
        return String.format("%d_%d%s", GlobalVariable.Companion.get().getUserId(), time, EXTENSION);
    }

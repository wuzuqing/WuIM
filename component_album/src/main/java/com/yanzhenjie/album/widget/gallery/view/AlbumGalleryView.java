...
import com.yanzhenjie.album.widget.gallery.adapter.GalleryPhotoAdapter;
import com.yanzhenjie.album.widget.gallery.model.GalleryPhotoModel;
import com.yanzhenjie.album.widget.gallery.model.GalleryPhotoParameterModel;
import com.yanzhenjie.album.widget.gallery.util.GalleryDownLoadCallBack;
import com.yanzhenjie.album.widget.gallery.util.GalleryDownloadThread;
import com.yanzhenjie.album.widget.gallery.util.GalleryScreenUtil;
...
public class AlbumGalleryView extends RelativeLayout {
    ...
    public AlbumGalleryView(Context context) {
        this(context, null);
    }

    public AlbumGalleryView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AlbumGalleryView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.AlbumGalleryView);
            animDuration = typedArray.getInt(R.styleable.AlbumGalleryView_album_animDuration, DEFAULT_ANIM_DURATION);
            saveText = typedArray.getString(R.styleable.AlbumGalleryView_album_saveText);
            saveTextSize = typedArray.getDimensionPixelSize(R.styleable.AlbumGalleryView_album_saveTextSize, 0);
            saveTextColor = typedArray.getColor(R.styleable.AlbumGalleryView_album_saveTextColor, 0);
        } else {
...
//        boolean isFocus = requestFocus();
    ...
    private void initView() {
        View view = View.inflate(getContext(), R.layout.album_gallery_view_main, this);
    ...
    private void initData() {
        ...
        viewPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                AlbumGalleryView.this.position = position;

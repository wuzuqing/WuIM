...
import com.yanzhenjie.album.util.GetPathFromUri4kitkat;
...
public class CameraActivity extends BaseActivity {
    ...
    private static final String INSTANCE_CAMERA_CROP = "INSTANCE_CAMERA_CROP";
    ...
    public static final int CODE_ACTIVITY_CROP_IMAGE = 3;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            isCrop = savedInstanceState.getBoolean(INSTANCE_CAMERA_CROP);
        } else {
            ...
            isCrop = bundle.getBoolean(Album.KEY_INPUT_FILE_CROP);
            switch (mFunction) {
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(INSTANCE_CAMERA_CROP, isCrop);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        switch (requestCode) {
            case CODE_ACTIVITY_TAKE_IMAGE:
                if (isCrop){
                    outUri =  AlbumUtils.startPhotoZoom(this,CODE_ACTIVITY_CROP_IMAGE,mCameraFilePath);
                }else{
                    setCallBack(resultCode);
                }
                break;
            ...
            case CODE_ACTIVITY_CROP_IMAGE:
                if (resultCode == RESULT_OK) {
                    mCameraFilePath = GetPathFromUri4kitkat.getPath(this,outUri);
                    callbackResult();
                } else {
                    callbackCancel();
                }
